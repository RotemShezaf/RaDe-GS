...
#
# ---------------------------------------------------------------------------------------------------------------------#
GEODESIC_NAME = "fmmdist"
COMPILER_DIRECTIVES = {"language_level": 3, }
INCLUDE_DIRS = [np.get_include()]  # NumPy dtypes
INSTALL_REQUIREMENTS = ["numpy", "scipy", "cython"]
DEFINED_MACROS = [("NDEBUG", 1)]  # Disable assertions; one is failing geodesic_mesh.h:405
...
# For LINUX:
extra_compile_args = ["--std=c++17", '-fpermissive', "-fopenmp", "-ffast-math"]
extra_link_args = ["--std=c++17", "-fopenmp", "-ffast-math"]
