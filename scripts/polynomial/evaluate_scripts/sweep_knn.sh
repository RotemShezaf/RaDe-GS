...
#
# USAGE:
#   bash scripts/polynomial/evaluate_scripts/sweep_knn.sh [options]
#
# OPTIONS:
...
#
# EXAMPLES:
#   bash scripts/polynomial/evaluate_scripts/sweep_knn.sh
#   bash scripts/polynomial/evaluate_scripts/sweep_knn.sh --k_values 8,10,12,14 --levels level_04
...
# ============================================================================
echo "============================================================"
echo "Sweep kNN k for Polynomial Surfaces (one_source)"
echo "============================================================"
