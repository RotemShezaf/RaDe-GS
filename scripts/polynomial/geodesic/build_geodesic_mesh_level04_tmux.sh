#!/bin/bash
#
# Build geodesic meshes for level 04 only, inside a tmux session on a SLURM node.
#
# USAGE:
#   bash scripts/polynomial/geodesic/build_geodesic_mesh_level04_tmux.sh [options]
#
# OPTIONS:
...
#   --session NAME     tmux session name (default: build_geo_mesh_l04)
...
#
# EXAMPLES:
#   bash scripts/polynomial/geodesic/build_geodesic_mesh_level04_tmux.sh
#   bash scripts/polynomial/geodesic/build_geodesic_mesh_level04_tmux.sh --node gipdeep9 --cpus 55
#   bash scripts/polynomial/geodesic/build_geodesic_mesh_level04_tmux.sh --dry_run
...
CPUS=60
TIME="24:00:00"
SESSION_NAME="build_geo_mesh_l04"
CONDA_ENV="geo_splat"
EXTRA=""
DRY_RUN=false
SKIP_EXISTING=""
...
bash $BUILD_SCRIPT --verbose --levels 04 $SKIP_EXISTING $EXTRA"
...
# ============================================================================
echo "============================================================"
echo "Build Geodesic Meshes (level 04) – tmux launcher"
echo "============================================================"
