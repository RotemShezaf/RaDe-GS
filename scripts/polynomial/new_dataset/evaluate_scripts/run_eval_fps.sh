...
#
# USAGE:
#   bash scripts/polynomial/new_dataset/evaluate_scripts/run_eval_fps.sh [options]
#
# OPTIONS:
...
# ============================================================================
echo "============================================================"
echo "Evaluate Geodesic Propagation with FPS (new_dataset)"
echo "============================================================"
