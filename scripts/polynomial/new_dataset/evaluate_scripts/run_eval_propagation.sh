...
#
# USAGE:
#   bash scripts/polynomial/new_dataset/evaluate_scripts/run_eval_propagation.sh [options]
#
# OPTIONS:
...
EXTRA=""
DRY_RUN=false
SESSION_NAME="eval_propagation_nd"
CONDA_ENV="geo_splat"
CPUS_PER_GPU=6
...
# ============================================================================
echo "============================================================"
echo "Debug: FM Propagation Evaluation (new_dataset, first N visited)"
echo "============================================================"
