...
#
# USAGE:
#   bash scripts/polynomial/new_dataset/evaluate_scripts/evaluate_geodesic.sh [options]
#
# OPTIONS:
...
# ============================================================================
echo "============================================================"
echo "Evaluate Geodesic Propagation (new_dataset)"
echo "============================================================"
