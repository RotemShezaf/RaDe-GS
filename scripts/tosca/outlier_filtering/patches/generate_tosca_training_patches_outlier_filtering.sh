#!/bin/bash
#
# Generate TOSCA training patches (outlier filtering) for all animals
#
# This script generates Gaussian training patches for each TOSCA shape
# with outlier filtering enabled. For each shape it:
...
#
# Dataset configs used from DataSets/configs/tosca/outlier_filtering/
#
# USAGE:
#   ./scripts/tosca/outlier_filtering/patches/generate_tosca_training_patches_outlier_filtering.sh [options]
#
# OPTIONS:
...
#   ./scripts/tosca/outlier_filtering/patches/generate_tosca_training_patches_outlier_filtering.sh
#
#   # Generate only for specific animals
#   ./scripts/tosca/outlier_filtering/patches/generate_tosca_training_patches_outlier_filtering.sh --animals "cat,dog"
#
#   # Dry run
#   ./scripts/tosca/outlier_filtering/patches/generate_tosca_training_patches_outlier_filtering.sh --dry_run
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo ""
            echo "Generate TOSCA training patches with outlier filtering enabled."
            echo ""
            echo "Options:"
...
CONFIG_DIR="DataSets/configs/tosca/outlier_filtering"
...
echo ""
echo "============================================================"
echo "Generate TOSCA Training Patches (outlier filtering)"
echo "============================================================"
...
echo ""
echo "All TOSCA patch generation (outlier filtering) complete."
