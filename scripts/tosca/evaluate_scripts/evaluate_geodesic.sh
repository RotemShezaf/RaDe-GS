...
#
# USAGE:
#   bash scripts/tosca/evaluate_scripts/evaluate_geodesic.sh [options]
#
# OPTIONS:
...
MODEL_PATH=""
GAUSSIAN_OUTPUT="TrainData/TOSCA/SyntheticColmapData/blue_texture/cat2/high_res/decoupled_appearance/output"
DATASET_CONFIG=""
SOURCE_INDICES=""
REFINE_PASSES="0"
EXTRA=""
DRY_RUN=false
SESSION_NAME="eval_geodesic_tosca${EVAL_SHAPE_SUFFIX:-}"
CONDA_ENV="geo_splat"
CPUS_PER_GPU=6
...
# ============================================================================
echo "============================================================"
echo "Evaluate Geodesic Propagation (TOSCA)"
echo "============================================================"
