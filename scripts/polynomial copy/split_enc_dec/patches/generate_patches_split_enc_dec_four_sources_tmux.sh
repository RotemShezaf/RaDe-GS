#!/bin/bash
#
# Generate polynomial training patches (split_enc_dec, 4-source) inside a tmux session.
#
# Same as generate_patches_split_enc_dec_tmux.sh but defaults to 4-source
# configs (paraboloid_all.yaml, saddle_all.yaml, hyperbolic_paraboloid_all.yaml).
#
# USAGE:
#   bash scripts/polynomial/split_enc_dec/patches/generate_patches_split_enc_dec_four_sources_tmux.sh [options]
#
# OPTIONS:
...
#   --session NAME     tmux session name (default: gen_patches_sed_4s)
#   --conda_env NAME   Conda environment (default: geo_splat)
#   --extra "ARGS"     Extra args forwarded to the generation script
#   --dry_run          Print commands without executing
#
# EXAMPLES:
#   bash scripts/polynomial/split_enc_dec/patches/generate_patches_split_enc_dec_four_sources_tmux.sh
#   bash scripts/polynomial/split_enc_dec/patches/generate_patches_split_enc_dec_four_sources_tmux.sh --node gipdeep12
...
CPUS=70
TIME="24:00:00"
SESSION_NAME="gen_patches_sed_4s"
CONDA_ENV="geo_splat"
EXTRA=""
DRY_RUN=false
...
# ============================================================================
echo "============================================================"
echo "Generate Polynomial Patches (split_enc_dec, 4-source) – tmux"
echo "============================================================"
