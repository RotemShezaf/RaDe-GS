...
#
# USAGE:
#   bash scripts/polynomial/geodesic_attention/evaluate_scripts/evaluate_model_vs_gt.sh [options]
#
# OPTIONS:
...
TRAIN_CONFIG="/home/rotem.shezaf/RaDe-GS/models/configs/geodesic_attention/combined_polynomial_ring3.yaml"
DATASET_CONFIG="/home/rotem.shezaf/RaDe-GS/DataSets/configs/polynomial/new_dataset/combined_polynomial_all_one_source.yaml"
EXTRA=""
DRY_RUN=false
SESSION_NAME="eval_model_vs_gt_ga"
CONDA_ENV="geo_splat"
CPUS_PER_GPU=6
...
# ============================================================================
echo "============================================================"
echo "Evaluate Model vs Ground-Truth Geodesic Distances (geodesic_attention)"
echo "============================================================"
