...
# ============================================================================
SUMMARY_SCRIPT="$PROJECT_ROOT/scripts/polynomial/geodesic/summarize_mesh_statistics.py"

INNER_CMD="cd $PROJECT_ROOT && \
source \$(conda info --base)/etc/profile.d/conda.sh && \
conda activate $CONDA_ENV && \
bash $COMPUTE_SCRIPT --verbose $SKIP_EXISTING $EXTRA && \
echo '' && echo '========== Mesh Summary ==========' && \
python $SUMMARY_SCRIPT --data_root $PROJECT_ROOT/TrainData/Polynomial/SyntheticColmapData/blue_texture"
