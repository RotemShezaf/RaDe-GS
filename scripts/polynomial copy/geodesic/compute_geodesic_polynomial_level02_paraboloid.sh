...
CPUS=80
TIME="24:00:00"
SESSION_NAME="compute_geo_l02_paraboloid"
CONDA_ENV="geo_splat"
EXTRA=""
DRY_RUN=false
SKIP_EXISTING=""
...
bash $COMPUTE_SCRIPT --verbose --levels 02  --surfaces Paraboloid --num_parallel_outputs 1 --light_ids 3 $SKIP_EXISTING $EXTRA"
