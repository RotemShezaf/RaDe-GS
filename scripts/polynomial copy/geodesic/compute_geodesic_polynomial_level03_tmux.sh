#!/bin/bash
#
# Launch compute_geodesic_polynomial_all.sh for level 03 only,
# inside a tmux session on a SLURM node.
#
# USAGE:
#   bash scripts/polynomial/geodesic/compute_geodesic_polynomial_level03_tmux.sh [options]
#
# OPTIONS:
...
#   --session NAME     tmux session name (default: compute_geo_l03)
...
#
# EXAMPLES:
#   bash scripts/polynomial/geodesic/compute_geodesic_polynomial_level03_tmux.sh
#   bash scripts/polynomial/geodesic/compute_geodesic_polynomial_level03_tmux.sh --node gipdeep9 --cpus 55
#   bash scripts/polynomial/geodesic/compute_geodesic_polynomial_level03_tmux.sh --dry_run
...
bash $COMPUTE_SCRIPT --verbose --levels 03 --num_parallel_outputs 1 $SKIP_EXISTING $EXTRA"
...
# ============================================================================
echo "============================================================"
echo "Compute Geodesic Distances (level 03) – tmux launcher"
echo "============================================================"
