#!/bin/bash
#
# Build geodesic meshes for level 03 only, inside a tmux session on a SLURM node.
#
# USAGE:
#   bash scripts/polynomial/geodesic/build_geodesic_mesh_level03_tmux.sh [options]
#
# OPTIONS:
...
#   --session NAME     tmux session name (default: build_geo_mesh_l03)
...
#
# EXAMPLES:
#   bash scripts/polynomial/geodesic/build_geodesic_mesh_level03_tmux.sh
#   bash scripts/polynomial/geodesic/build_geodesic_mesh_level03_tmux.sh --node gipdeep9 --cpus 55
#   bash scripts/polynomial/geodesic/build_geodesic_mesh_level03_tmux.sh --dry_run
...
CPUS=70
TIME="24:00:00"
SESSION_NAME="build_geo_mesh_l03"
CONDA_ENV="geo_splat"
EXTRA=""
DRY_RUN=false
SKIP_EXISTING=""
...
bash $BUILD_SCRIPT --verbose --levels 03 $SKIP_EXISTING $EXTRA"
...
# ============================================================================
echo "============================================================"
echo "Build Geodesic Meshes (level 03) – tmux launcher"
echo "============================================================"
