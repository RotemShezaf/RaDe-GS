#!/bin/bash
#
# Launch compute_geodesic_polynomial_all.sh for level 02 only,
# inside a tmux session on a SLURM node.
#
# USAGE:
#   bash scripts/polynomial/geodesic/compute_geodesic_polynomial_level02_tmux.sh [options]
#
# OPTIONS:
...
#   --session NAME     tmux session name (default: compute_geo_l02)
...
#
# EXAMPLES:
#   bash scripts/polynomial/geodesic/compute_geodesic_polynomial_level02_tmux.sh
#   bash scripts/polynomial/geodesic/compute_geodesic_polynomial_level02_tmux.sh --node gipdeep9 --cpus 55
#   bash scripts/polynomial/geodesic/compute_geodesic_polynomial_level02_tmux.sh --dry_run
...
CPUS=38
TIME="24:00:00"
SESSION_NAME="compute_geo_l02_copy"
CONDA_ENV="geo_splat"
EXTRA=""
DRY_RUN=false
SKIP_EXISTING=""
...
bash $COMPUTE_SCRIPT --verbose --levels 02  --surfaces HyperbolicParaboloid --num_parallel_outputs 1 --light_ids 2 $SKIP_EXISTING $EXTRA"
...
# ============================================================================
echo "============================================================"
echo "Compute Geodesic Distances (level 02) – tmux launcher"
echo "============================================================"
