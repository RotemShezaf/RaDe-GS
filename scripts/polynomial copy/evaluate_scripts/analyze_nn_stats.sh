...
#
# USAGE:
#   bash scripts/polynomial/evaluate_scripts/analyze_nn_stats.sh [options]
#
# OPTIONS:
...
NODE="gipdeep7"
TIME="2:00:00"
CONFIG="/home/rotem.shezaf/RaDe-GS/models/configs/one_source/combined_polynomial_ring3.yaml"
MODEL_PATH="/home/rotem.shezaf/RaDe-GS/checkpoints/one_source/combined_polynomial_ring3/best_model.pth"
GAUSSIAN_DIR=""
EXTRA=""
DRY_RUN=false
SESSION_NAME="eval_nn_stats"
CONDA_ENV="geo_splat"
CPUS_PER_GPU=6
...
# ============================================================================
echo "============================================================"
echo "Analyze NN Statistics (one_source)"
echo "============================================================"
