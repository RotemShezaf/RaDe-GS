...
#
# USAGE:
#   bash scripts/polynomial/evaluate_scripts/run_eval_propagation.sh [options]
#
# OPTIONS:
...
# ============================================================================
echo "============================================================"
echo "Debug: FM Propagation Evaluation (one_source, first N visited)"
echo "============================================================"
