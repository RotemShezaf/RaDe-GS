...
#
# USAGE:
#   bash scripts/polynomial/new_dataset/evaluate_scripts/evaluate_model_vs_gt.sh [options]
#
# OPTIONS:
...
MODEL_PATH=""
TRAIN_CONFIG="/home/rotem.shezaf/RaDe-GS/models/configs/new_dataset/combined_polynomial_ring3_noisy_geo.yaml"
DATASET_CONFIG=""
EXTRA=""
DRY_RUN=false
SESSION_NAME="eval_model_vs_gt_nd"
CONDA_ENV="geo_splat"
CPUS_PER_GPU=6
...
# ============================================================================
echo "============================================================"
echo "Evaluate Model vs Ground-Truth Geodesic Distances (new_dataset)"
echo "============================================================"
